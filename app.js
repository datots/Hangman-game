...
mainsection.style.backgroundColor = "#5C8D89";
mainsection.style.border = "15px solid green";
mainsection.style.width = "1240px";
...
rightContainer.style.height = "700px  ";
rightContainer.style.marginTop = "300px";
